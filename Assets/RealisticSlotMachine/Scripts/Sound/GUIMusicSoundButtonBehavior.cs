...
namespace Mkey
{
    ...
    public class GUIMusicSoundButtonBehavior : MonoBehaviour
    {
        ...
        private void Refresh()
        {
            ...
            string localizedStringON = Constants.GetLocalizedString("Setting", "ON");
            Debug.LogError(localizedStringON);
            if (textOnOff) textOnOff.text = (on) ? localizedStringON : Constants.GetLocalizedString("Setting", "OFF");
        }
    }
}
